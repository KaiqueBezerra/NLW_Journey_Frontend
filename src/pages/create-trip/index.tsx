...
export function CreateTripPage() {
  ...
  const [isConfirmTripModalOpen, setIsConfirmTripModalOpen] = React.useState(false)
  const [emailsToInvite, setEmailsToInvite] = React.useState<string[]>([])

  const [destination, setDestination] = React.useState('')
  const [ownerName, setOwnerName] = React.useState('')
  const [ownerEmail, setOwnerEmail] = React.useState('')
  const [eventStartAndEndDates, setEventStartAndEndDates] = React.useState<DateRange | undefined >()
