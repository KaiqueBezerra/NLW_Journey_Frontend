...
export function InviteGuestsModal({openGuestModal, emailsToInvite, removeEmailFromInvites, addNewEmailToEnvite}: InviteGuestsModalProps) {
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center">
              <div className="w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  {emailsToInvite.map(email => <div key={email} className="py-1.5 px-2.5 rounded-md bg-zinc-800 flex items-center gap-2">
